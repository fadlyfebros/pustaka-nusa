    ...
    <div class="login-container">
        ...
        <form action="{{ route('password.update', $token) }}" method="POST">
            ...
            <div class="mb-3 position-relative">
                <input type="password" id="new_password" name="password" class="form-control" placeholder="Password Baru" required>
                <span class="position-absolute top-50 end-0 translate-middle-y me-3">
                    <i class="bi bi-eye-slash" id="toggleNewPassword" style="cursor: pointer; font-size: 1.2rem;"></i>
                </span>
            </div>
